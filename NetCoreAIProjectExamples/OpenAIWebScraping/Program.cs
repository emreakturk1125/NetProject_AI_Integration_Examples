...
/// <summary>
/// Bu kod, kullanıcının verdiği bir web sayfası URL'sini analiz edip özetleyen bir C# programıdır.
/// Bu program, web sayfalarındaki içerikleri otomatik olarak analiz etmek ve Türkçe özet çıkarmak için kullanılır.
/// </summary>
