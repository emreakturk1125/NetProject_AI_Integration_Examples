...
internal class Program
{
    ...
    private static readonly string rssFeedUrl = "https://www.haberturk.com/rss";
    ...
    private static async Task<List<string>> FetchLatestNews(int count)
    {
    ...
    private static async Task<string> SummarizeArticle(string articleText)
    {
        var client = new HttpClient();
